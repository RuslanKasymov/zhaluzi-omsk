...
<div class="jshop" id="comjshop">
    ...
    <? //var_dump($this->category->category_image);?>
    <div class="category_description">
        <?php print $this->category->description?>
    </div>

    <?php if ( isset($this->category->category_image)  &&  $this->category->category_image != '' ) { ?>
        <img src="/components/com_jshopping/files/img_categories/<?php echo $this->category->category_image; ?>" />
    <?php } ;?>
